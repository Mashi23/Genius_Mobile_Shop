...
<section id="cart" class="py-3">
    <div class="container-fluid w-75">
        <h5 class="font-rubik fs-3  text-center">Wish List</h5>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                foreach($info->getData('wishlist') as $item):
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                        ...
                                        <button type="submit" name="cart-submit" class="btn font-rubik text-success">Add to Cart</button>
                                    </form>
