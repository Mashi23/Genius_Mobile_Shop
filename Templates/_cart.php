        ...
        <div class="row">
            <div class="col-sm-9">
                <?php
                    ...
                    foreach($info->getData('cart') as $item):
                        $cart = $info->getinfo($item['item_id']);
                ...
                <div class="row border-top py-3 mt-3">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="#" class="px-2 font-rubik font-size-14">19,534 ratings</a>
                        </div>
                        <!--  !product rating-->
                        ...
                        <div class="qty d-flex pt-2">
                            ...
                            <form method="post">
                                ...
                                <button type="submit" name="cart-delete" class="btn font-rubik text-danger px-3 border-right">Delete</button>
                            </form>

                            <form method="post">
                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                <button type="submit" name="wishlist-submit" class="btn font-rubik text-success">Add to Wishlist</button>
                            </form>
